  ...
  <div class="container">
    ...
    <div class="tag-box">
      ...
      <el-input
        ...
        size="small"
      ></el-input>
      <el-button v-else @click="showInputBtn" size="small" class="button-new-tag">+标签</el-button>
    </div>
    <el-input
      type="textarea"
      :autosize="{ minRows: 25 }"
    ...
    <div class="publish-box">
      ...
      <el-checkbox v-model="post.isShowContent" style="margin: 10px 20px"
        >发布后展示内容</el-checkbox
      >
      <el-checkbox v-model="post.isCommentable" style="margin: 10px 10px">开启评论区</el-checkbox>
